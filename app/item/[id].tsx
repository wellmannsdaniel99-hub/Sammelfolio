  ...
  return (
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Pressable style={styles.add}><Text style={styles.addText}>+ Zur Sammlung hinzufügen</Text></Pressable>
        <Text style={styles.note}>Im nächsten Schritt bekommt dieser Button Menge, Zustand, Kaufpreis und Kaufdatum.</Text>
      </ScrollView>
    </SafeAreaView>
  );
}
