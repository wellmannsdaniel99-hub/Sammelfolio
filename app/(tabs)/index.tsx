...
function BrandMark() {
  return <View style={styles.logo}><View style={styles.logoCardA}/><View style={styles.logoCardB}/><Text style={styles.logoS}>S</Text></View>;
}
