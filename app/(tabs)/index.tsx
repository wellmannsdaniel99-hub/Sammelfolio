...
export default function PortfolioScreen() {
  ...
  return <SafeAreaView style={styles.safe}><ScrollView contentContainerStyle={styles.container}>
    ...
    <View style={styles.sealedBadge}><Text style={styles.sealedBadgeText}>SEALED = UNGEÖFFNETE PRODUKTE · KARTEN SIND NATÜRLICH AUCH DABEI</Text></View>
