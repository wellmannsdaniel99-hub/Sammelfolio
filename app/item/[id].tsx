  ...
  return (
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.art}><Text style={styles.artText}>{item.productType === 'Top-Trainer-Box' ? 'TOP-TRAINER-BOX' : 'SEALED'}</Text></View>
        ...
        <View style={styles.market}>
          ...
          <Text style={styles.note}>Vorläufiger Sealed-Wert · echte Preisquelle folgt.</Text>
        </View>
        ...
        <View style={styles.row}><Text style={styles.key}>Preisstatus</Text><Text style={styles.val}>Platzhalter</Text></View>
